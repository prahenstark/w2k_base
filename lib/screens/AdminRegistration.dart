...
class AdminRegistration extends StatefulWidget {
  static const String id = 'admin_registration';
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            RoundedButton(
              ...
              onPressed: () {
                Navigator.pushNamed(context, AdminLunchScreen.id);
              },
              // onPressed: () async {
              //   // setState(() {
              //   //   showSpinner = true;
